...
import { getAllCurrencies } from '../../api/auth'
          ...
          <div className="col-md-9 col-lg-7 col-xl-6 mx-auto">
            <div className="bg-white shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
              ...
              <form id="form-send-money" method="post">
                ...
                <div className="mb-3">
                    <label hmtlFor="youSend" className="form-label">Sender’s Currency</label>
                        ...
                        <select 
                          ...
                          <optgroup label="Other Currency">
                            ...
                            <button 
                              type="button" 
                              tabIndex="-1" 
                              className="btn dropdown-toggle bs-placeholder form-select bg-transparent border-0" 
                            ...
                            <div className="filter-option">
                              <div className="filter-option-inner">
                                <div className="filter-option-inner-inner">
                                  <i className=" currency-flag currency-flag-usd me-1"></i>
                                    &nbsp;USD
                                  </div>
                                </div> 
                            </div>
                ...
                <div className="mb-3">
                    ...
                    >
                    {
                      curriencies.map(currency => (
                        <option value={currency.currencyCode}>{currency.countryCode}</option>
                        ))
                    }
                    </select>
                </div>
                {/* <div className="mb-3">
                    <label hmtlFor="youSend" className="form-label">Receiver's Currency</label>
                    <div className="input-group">
                      <span class="input-group-text">&#8358;</span>
                        <input type="text" className="form-control" data-bv-field="youSend" id="youSend" value="451,000" placeholder=""/>
                      <span className="input-group-text p-0">
                        <div className="dropdown bootstrap-select bg-transparent form-control dropup">
                        <select 
                            id="youSendCurrency" 
                          ...
                          <optgroup label="Other Currency">
                            ...
                            <button 
                              type="button" 
                              tabIndex="-1" 
                              class="btn dropdown-toggle bs-placeholder form-select bg-transparent border-0" 
                              data-bs-toggle="dropdown" 
                              role="combobox" 
                              aria-owns="bs-select-1" 
                              aria-haspopup="listbox" 
                            ...
                            <div className="filter-option">
                              <div className="filter-option-inner">
                                <div className="filter-option-inner-inner">
                                  <i className=" currency-flag currency-flag-ngn me-1"></i>
                                    &nbsp;NGN
                                  </div>
                                </div> 
                            </div>
                ...
                {/* <div className="mb-3">
                  <label htmlfor="OtherName" className="form-label">Beneficiary Othername</label>
                  <input type="text" value="" className="form-control" data-bv-field="name" id="OtherName"
                    required placeholder="Enter Beneficiary Lastname" />
                </div> */}
                {/* <div className="mb-3">
                  <label htmlfor="Address" className="form-label">Beneficiary Address 1</label>
                ...
                {/* <div className="mb-3">
                  <label htmlfor="Address2" className="form-label">Beneficiary Address 2</label>
                  <input type="text" value="" className="form-control" data-bv-field="address"
                    id="Address2" required placeholder="Enter Beneficiary Address" />
                </div> */}
                {/* <div className="mb-3">
                ...
                <div className="mb-3">
                  <label htmlFor="mode" className="form-label">Mode of Collection</label>
                  <select className="form-select" id="mode" name="mode">  
                    <option value="Cash">Cash</option>
                    <option value="Direct-to-account">Direct-to-account</option>
                  </select>
                </div>  
                {/* <div className="mb-3">
                ...
                {/* <p className="text-muted text-center">
                  ...
                  <span className="fw-500">
                    1USD = 14.39 GHS Cedis
                  </span>
                </p> */}
                <p className="text-muted text-center">
                  continue to next screen to input beneficiary details
                </p>
                {/* <hr /> */}
                ...
                <div className="d-grid"><button className="btn btn-primary"  onClick={() => navigate('/dashboard/fund/send/confirm')}>Continue</button></div>
              </form>
            </div>
          </div>
        </div>
